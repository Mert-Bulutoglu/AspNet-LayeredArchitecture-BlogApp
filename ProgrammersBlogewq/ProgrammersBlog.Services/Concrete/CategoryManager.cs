...
namespace ProgrammersBlog.Services.Concrete
{
    public class CategoryManager:ICategoryService
    {
        ...
        /// </summary>
        /// <param name="categoryId">0'dan büyük integerbir ID değeri</param>
        /// <returns>Asenkron bir operasyonm ile Task olarak işlem sonucu DataResult tipinde geriye döner.</returns>
        ...
        public async Task<IDataResult<int>> CountAsync()
        {
            ...
            {
                return new DataResult<int>(ResultStatus.Error,$"Beklenmeyen bir hatayla karşılaşıldı.",-1);
            }
        }
